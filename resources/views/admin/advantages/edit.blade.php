                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4 class="m-0">{{ __('body.Update Advantage') }}</h4>

                            <div class="my-2">
                                <a href="{{ Route('dash.advantages.index') }}"
                        ...
                        <form action="{{ Route('dash.advantages.update', $advantage->id) }}" enctype="multipart/form-data"
                            method="POST">
                            @method('PUT')
                            @csrf
                            <!-- Tab panes -->
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="icon_id" id="icon_id" class="select2 form-select">
                                                ...
                                                @foreach ($icons as $icon)
                                                    <option value="{{ $icon['id'] }}" @selected($advantage->icon_id == $icon['id'])
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 d-flex flex-column">
                                            <label class="form-label" for="advantage-image">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <button type="submit" id="advantage-update"
