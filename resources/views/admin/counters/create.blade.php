                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4 class="m-0">{{ __('body.Create Counter') }}</h4>
                        ...
                        <form action="{{ Route('dash.counters.store') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <!-- Tab panes -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="secondary_icon_id" id="secondary_icon_id"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <button type="submit" id="counter-create"
