                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4 class="m-0">{{ __('body.Update FAQ') }}</h4>

                            <div class="my-2">
                                <a href="{{ Route('dash.faqs.index') }}"
                        ...
                        <form action="{{ Route('dash.faqs.update', $faq->id) }}" enctype="multipart/form-data"
                            method="POST">
                            @method('PUT')
                            @csrf
                            <!-- Tab panes -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <button type="submit" id="faq-update"
